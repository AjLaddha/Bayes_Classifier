...
def main():
        ...
        # p3=len(train_list3)/(len(train_list1)+len(train_list2)+len(train_list3))
        ...
        #     class_identified=nb.boundary_decision(mean1,mean2,mean3,cov_matrix,test_list3[i])
        ...
        for key in my_dict:
            ...
            for i in range (len(li)):
                ...
                #     val[2]=val[2]+1
        # print val
        # val[0]=len(my_dict["C1"])/val[0]
        # val[1]=len(my_dict["C2"])/val[1]
        # val[2]=len(my_dict["C3"])/val[2]
        # print val
