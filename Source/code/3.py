...
class GaussNB:
    ...
    def boundary_decision(self,mean1,mean2,mean3,cov1,cov2,cov3,p1,p2,p3,x):
...
def main():
        ...
        for i in range(len(test_list1)):
            class_identified = nb.boundary_decision(mean1,mean2,mean3,cov_matrix1,cov_matrix2,cov_matrix3,p1,p2,p3,test_list1[i])
        ...
        for i in range(len(test_list2)):
            class_identified=nb.boundary_decision(mean1,mean2,mean3,cov_matrix1,cov_matrix2,cov_matrix3,p1,p2,p3,test_list2[i])
        ...
        b = []
        c = []
        for i in tqdm(drange2(int(min_y-1), int(max_y+1),2)):
        	for j in tqdm(drange2(int(min_x-1), int(max_x+1), 2)):
        		temp = []
        		temp.append(j)
        		temp.append(i)
        		class_identified = nb.boundary_decision(mean1, mean2, mean3, cov_matrix1,cov_matrix2,cov_matrix3,p1,p2,p3,temp)
        		Z = -1
        		if class_identified == "C1" :
        			a.append(temp)
        		elif class_identified == "C2":
